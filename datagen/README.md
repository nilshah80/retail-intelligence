...
Source spec v12 supports the locale-pack range `2005-01-01` through `2026-12-31`: up to 22
...
single DuckDB mirror is the complete v12 publication matrix; JSONL remains an ingestion adapter
...
The currently accepted Phase-2 and ML input is the v0.13.0/v12 run generated by the command above:

```text
run id:          run-c5eb1506ecd4c550
config hash:     ae0f74be19d850079934ee8f87858d10b46ac9d3ec93baea8e97a58b989f57e9
source dates:    2016-07-28 through 2026-07-28
local path:      datagen/output/multi-market-10-year-demo/run-c5eb1506ecd4c550
```
...
```text
manifest hash:   3ca63c09ce220c1606a1c73b6d1c8a74268cf437cc1ab620fcd49776747665a9
objects:         8,726
source rows:     252,864,055
run size:        16 GiB
generation:      4,594.755 s under performance; 13,915,750,400-byte peak process RSS
...
v0.13.0/v12 run named above; changing only an execution profile does not change its scenario
