...
The currently accepted Phase-2 input is the v0.12.0/v11 run generated by the command above:

```text
run id:          run-34b0ff729c8abe09
config hash:     3abbb96147c99c55e36e989a6eb6ba79305aab2caf0e1aa0cc200c1521853728
source dates:    2016-07-28 through 2026-07-28
local path:      datagen/output/multi-market-10-year-demo/run-34b0ff729c8abe09
```
...
v0.12.0/v11 run named above; changing only an execution profile does not change its scenario
